    ...
    <Box as="main" mb={10}>
      <VStack spacing={8} align="start" w={["90%", "75%", "50%"]} mx="auto" mt={24}>
        ...
        <Text fontSize="lg" color={subTextColor}>
          ...
          <br /><br />
          I specialize in creating interactive and responsive websites
          ...
          <br /><br />
          I take pride in my attention to
        ...
        <Heading as="h2" fontSize={["3xl", "4xl", "5xl"]} color={textColor} mt={8}>
          Mostly Used Tools
        </Heading>
      ...
      <SimpleGrid columns={[1, 2, 3, 4]} spacing={10} px={4} mx="auto" maxW="container.xl" mt={8}>
