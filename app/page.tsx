import { Box, Heading, Text, Button, VStack, HStack, Link, Image, useColorModeValue } from "@chakra-ui/react";
...
export default function Home() {
  ...
  return (
    <Box as="main" mb={10}>
      <VStack w={["90%", "75%", "50%"]} mx="auto" mt={24} spacing={8} align="start">
        ...
        <HStack spacing={6}>
          ...
          <Link href="https://www.linkedin.com/in/sami-bentaleb-a96293221/" isExternal>
